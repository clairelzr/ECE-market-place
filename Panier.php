...
<body>
	...
	<main>
		...
		<!-- Partie permettant d'afficher le panier d'une personne -->
		<div class="container">
			<div class="row">
				<div class="row">
					...
					<div class="col-lg-12" id="leftPart">
						...
						<div class="row elements">
							...
							<div class="col-lg-12">
								<p>Acheter les items de votre panier</p>	
								<a href="Achat.php"><input type="submit" name="button" value="Acheter"></a>	
