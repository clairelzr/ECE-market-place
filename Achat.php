...
<body>
	...
	<main>
		...
		<!-- Partie permettant d'afficher qu'un achat a bel et bien aboutit  -->
		<div class="container">
			<div class="row">
				<div class="row">
							...
							<div class="row elements">
								<div class="col-lg-12"> 
									...
									if(isset($_SESSION['noma'])){
										echo $_SESSION['prenoma']." <p>Votre achat a aboutit</p>";
									}
									if(isset($_SESSION['nomv'])){
										echo $_SESSION['prenomv']." <p>Votre achat a aboutit</p>";
									}
									?>
